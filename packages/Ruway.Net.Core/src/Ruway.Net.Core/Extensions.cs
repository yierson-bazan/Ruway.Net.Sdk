...
using Ruway.Net.Core.Abstractions.Models;
...
public static class Extensions
{
    ...
    public static IRuwayBuilder AddRuway(this IServiceCollection services, string sectionName = SectionName,
        IConfiguration configuration = null)
    {
        ...
        var builder = RuwayBuilder.Create(services, configuration);
    ...
    public static IApplicationBuilder UseRuway(this IApplicationBuilder app)
    {
    ...
    public static TModel GetOptions<TModel>(this IRuwayBuilder builder, string settingsSectionName)
        where TModel : new()
    {
